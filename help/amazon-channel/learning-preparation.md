---
title: Amazon セールスチャネル - [!UICONTROL Learning and Preparation]
...
The _[!UICONTROL Learning and Preparation]_「 」には、Amazonストアを統合する前に推奨される事前設定タスクのリストが表示されます。 また、次のような学習教材へのリンクも提供します。
